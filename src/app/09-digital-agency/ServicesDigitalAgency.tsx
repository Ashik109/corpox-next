...
function ServicesDigitalAgency() {
    return (
        <div className="tmp-service-area tmp-section-gapTop" id="service">
                    ...
                    <div className="col-lg-12">
                        ...
                        >
                            ...
                            <h2 className="title w-700 tmp-title-split">
                                Services <span className="theme-gradient">With Image.</span>
                            </h2>
...
export default ServicesDigitalAgency;
