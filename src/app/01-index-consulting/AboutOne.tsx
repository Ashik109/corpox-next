                ...
                <div className="row align-items-center">
                    <div className="col-lg-5">
                        <div className="thumbnail-about-8">
                            ...
                            <div ref={floatRef} className="small-iamge-area images-left-right-float">
                                <img
                        ...
                        <div className="about-wrapper-8">
                            <div className="tmp-section-title-border text-start">
                                ...
                                <h2 className="title w-700 tmp-title-split">
                                    Lets Know <span className="theme-gradient">About</span> Our{" "}
                                    <br /> Company
                                </h2>
                            </div>
                                ...
                                <li>
                                    <div className="icon">
                                        ...
                                        >
                                            ...
                                            <circle cx="50.5" cy="5.002" r={1} />
                                            <circle cx="50.5" cy="21.999" r={1} />
                                            <circle cx={42} cy="13.5" r={1} />
                                            <circle cx={59} cy="13.5" r={1} />
                                            <circle cx="43.14" cy="9.252" r={1} />
                                            <circle cx="57.86" cy="17.75" r={1} />
                                            <circle cx="46.25" cy="20.862" r={1} />
                                            <circle cx="54.75" cy="6.14" r={1} />
                                            <circle cx="43.14" cy="17.75" r={1} />
                                            <circle cx="57.86" cy="9.252" r={1} />
                                            <circle cx="54.75" cy="20.862" r={1} />
                                            <circle cx="46.25" cy="6.14" r={1} />
