...
const avatars = [
    ["tooltip-01.png", "Mark JOrdan"],
    ["tooltip-02.png", "Mark"],
    ["tooltip-03.png", "Jordan"],
];

function CtaBusinessThree() {
    return (
                                ...
                                <div className="inner">
                                    ...
                                    <div className="tmp-profile-box mt--50">
                                        <div className="profile-share justify-content-center">
                                            {avatars.map(([image, label]) => (
                                                <Link href="#" className="avatar" data-tooltip={label} tabIndex={0} key={image}>
...
export default CtaBusinessThree;
