function AppointmentCreativeAgency() {
    return (
        <div className="inv-appoinment-area-start tmp-section-gap">
            <div className="container">
                    ...
                    <div className="col-lg-12">
                        ...
                        >
                            ...
                            <p className="description b1 tmp-title-split-p">
                                Easily schedule your appointment with just a few clicks. Our team is <br />
                ...
                <div className="row g-5">
                    <div className="col-lg-5 mt_md--30 mt_sm--30" data-aos="fade-up" data-aos-duration="800">
                        <div className="aapoiment-left-area-thumbnail">
                            <img src="/assets/images/appoinment/01.webp" alt="appoinment" />
                        </div>
                    </div>
                    <div className="col-lg-7" data-aos="fade-up" data-aos-duration="800" data-aos-delay="150">
                        <form className="contact-form-1 appoinment-form-wrapper tmponhover tmp-dynamic-form" id="contact-form" method="POST" action="#">
...
export default AppointmentCreativeAgency;
