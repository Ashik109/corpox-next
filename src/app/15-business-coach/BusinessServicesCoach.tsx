...
const serviceList = [
    {
        ...
        image: "01.webp",
        icon: "01.svg",
        text: "Our business growth service helps companies expand faster with strategic planning, marketing solutions, and expert guidance to achieve sustainable success.",
        reverse: false,
    },
    {
        ...
        image: "02.webp",
        icon: "02.svg",
        text: "Our audit consulting service ensures transparency, compliance, and financial accuracy with expert guidance to optimize performance and reduce risks.",
        reverse: true,
    },
    {
        ...
        image: "03.webp",
        icon: "03.svg",
        text: "Our Financial Idea service helps companies expand faster with strategic planning, marketing solutions, and expert guidance to achieve sustainable success.",
        reverse: false,
    },
    {
        ...
        image: "04.webp",
        icon: "04.svg",
        text: "Our minimal achievement strategy focuses on steady growth, smart resource use, and sustainable progress to reach goals with efficiency.",
        reverse: true,
    },
];
...
function ServiceRow({ item }: { item: (typeof serviceList)[number] }) {
    ...
    return (
        <div className="single-service-list-area" data-aos="slide-up" data-aos-delay="100" data-aos-duration="700">
...
function BusinessServicesCoach() {
    return (
...
export default BusinessServicesCoach;
