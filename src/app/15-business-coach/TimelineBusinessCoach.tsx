...
function TimelineBusinessCoach() {
    return (
        <div className="tmp-timeline-area pb--70">
                        ...
                        <div className="tmp-section-title-border text-center" data-aos="slide-up" data-aos-delay="100" data-aos-duration="700">
                            <div className="pres-line-separator-wrapper text-center mb--10">
                                ...
                                <span className="subtitle">
                                    ...
                                    <span className="subtitle-text">Our Working Process</span>
                                </span>
                                <div className="line-separator line-right" />
                            </div>
                            <h2 className="title w-700">How We Do It?</h2>
...
export default TimelineBusinessCoach;
