function SectionElementsArea() {
  return (
    <>
      <div className="tmp-elements-area tmp-section-gapBottom">
      <div className="container">
      <div className="row">
      <div className="col-lg-12">
      <div className="entry-content">
      <h4 className="w-700">ThemesPark Terms of Service and Privacy Policy</h4>
      <ol>
      <li>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor
                                          ...
                                          pariatur (the “<strong>Sites</strong>”).</li>
      <li>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium
                                          doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore
                                          veritatis et quasi architecto beatae vitae dicta sunt explicabo.</li>
      <li>Nemo enim ipsam voluptatem quia&nbsp;voluptas sit aspernatur&nbsp;aut odit aut
                                          ...
                                          labore et dolore magnam aliquam quaerat voluptatem.</li>
      </ol>
      <p><strong>The type of personal information we collect</strong></p>
      <ol start={4}>
      <li>Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit
                                          laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure
                                          reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel
                                          illum qui dolorem eum fugiat quo voluptas nulla pariatur.</li>
      </ol>
      <p><strong>How we collect personal information</strong></p>
      <ol start={6}>
      <li>I must explain to you how all this mistaken idea of denouncing pleasure and praising
      ...
      <li>On the other hand, we denounce with righteous indignation and dislike men who are so
                                          ...
                                          is the same as saying through shrinking from toil and pain.</li>
      <li>These cases are
                                          perfectly simple and easy to distinguish.&nbsp;In a free hour,</li>
      <li>when our power of
                                          ...
                                          circumstances and owing to the claims of duty or the obligations&nbsp;</li>
      </ol>
      </div>
      </div>
      </div>
