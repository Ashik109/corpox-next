...
function SectionSliderArea() {
  return (
    <>
      ...
      <span className="subtitle-text">Our Company's About
                                              Details.</span>
      </span>
      <div className="line-separator line-right"></div>
      </div>
      <h1 className="title w-700 mt--20">We are a Business & Consulting <br /> <span className="theme-gradient">Business
                                          Agency.</span></h1>
      ...
      <div className="thumbnail"><img className="radius-small" src="/assets/images/about/14.webp" alt="Corporate Image" /></div>
