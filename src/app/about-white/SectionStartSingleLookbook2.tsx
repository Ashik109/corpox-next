function SectionStartSingleLookbook2() {
  return (
    <>
      <div className="tmp-lookbook-portion portion-lg" data-tmp-position-vertical="45" data-tmp-position-horigental="30">
...
export default SectionStartSingleLookbook2
