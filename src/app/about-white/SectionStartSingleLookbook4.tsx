function SectionStartSingleLookbook4() {
  return (
    <>
      <div className="tmp-lookbook-portion" data-tmp-position-vertical="70" data-tmp-position-horigental="54">
      ...
      <span>
      <span className="tmp-fw-medium tmp-text-heading">Emily Rose</span> - UI/UX
                                                  Designer</span>
...
export default SectionStartSingleLookbook4
