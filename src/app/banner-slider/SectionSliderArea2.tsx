function SectionSliderArea2() {
  return (
    <>
      <div className="slider-animation-2 slider-activation-2 slider-dot tmp-slick-dot tmp-slick-arrow tmp-slick-arrow-white tmp-section-gapTop">
      ...
      <h1 className="title display-one">Build a Strong <br /> <span>Consulting</span> Agency.</h1>
      ...
      <div className="inner text-left">
      <h6 className="tag-title">SOLUTION FOR YOUR BUSINESS</h6>
      <h1 className="title display-one">Build a Strong <br /> <span>Creative</span> Agency.</h1>
      <p className="mb--40 b1">We provide you with user management functionality that results in faster
                                              development and revenue.</p>
      <div className="read-more-btn">
      <a className="tmp-btn btn-large round hover-icon-reverse" href="#">
      ...
      <div className="inner text-left">
      <h6 className="tag-title">SOLUTION FOR YOUR BUSINESS</h6>
      <h1 className="title display-one">Build a Strong <br /> <span>Digital Agency</span>.</h1>
      <p className="mb--40 b1">We provide you with user management functionality that results in faster
                                              development and revenue.</p>
      <div className="read-more-btn">
      <a className="tmp-btn btn-large round hover-icon-reverse" href="#">
