...
import MarketingOdometer from "./MarketingOdometer";

const footerColumns = [
    {
        title: "Quick Link",
        links: ["Recent work", "About us", "Testimonials", "News & Blog", "FAQ's"],
    },
    {
        title: "Company",
...
function FooterMarketingAgency() {
    return (
                        ...
                        <div className="left">
                            <div className="pres-line-separator-wrapper text-start mb--10 ml--0 justify-content-start">
                                <span className="subtitle mt--0" style={{ width: "auto" }}>
                                    <MarketingOdometer value={2999} />
                                    <span className="subtitle-text color-white">MARKETING STARTUP AGENCY</span>
                                </span>
                            </div>
                            <h3 className="tmp-text-white pr--80 pr_sm--0 pr_md--0">
                                We won&apos;t charge you for our{" "}
                                <span className="color-primary">Marketing</span> Deal for the first year.
                            </h3>
                        </div>
                        <div className="right">
                                    ...
                                    <div className="tmp-footer-widget">
                                        ...
                                        <ul className="tmp-list-footer tmp-list-has-left-icon">
                                            {column.links.map((link) => (
                                                <li key={link}>
                                                    <a href="#">
                                                        {link} <i className="feather-arrow-up-right" />
                                                    </a>
                                                </li>
                                            ))}
                                        </ul>
                            ...
                            <div className="tmp-footer-widget">
                                <div className="widget-inner">
                                    <div>
                                        ...
                                        <p className="mb--25">
                                            * We will send you weekly updates to help you manage your business better.
                                        </p>
                                    </div>
                                    <form className="tmp-newsletter-form" autoComplete="off">
                                        <div className="tmp-input-field mb--25">
                                            <input
                                                className="tmp-input-field-rounded tmp-input-bg-var-2"
                                                type="email"
                                                name="email"
                                        ...
                                        <div className="tmp-input-field">
                                            ...
                                            <label className="tmp-checkbox" htmlFor="tmp-checkbox-1">
...
export default FooterMarketingAgency;
