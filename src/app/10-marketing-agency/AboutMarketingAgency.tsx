                        ...
                        <div className="content">
                            <div className="tmp-section-title-border text-start">
                                <h2 className="title w-700 mb--30 tmp-title-split">
                                    We design and develop world-class web applications.
                                </h2>
                                <p>
                                    Our Business ipsum dolor sit amet consectetur, adipisicing elit. Tempora sequi
                                    doloremque dicta quia unde odio nam minus reiciendis ullam aliquam.
                                </p>
                                ...
                                <div className="read-more-btn mt--40">
                                    <Link className="tmp-btn round btn-large" href="/our-history">
                                        Check Our History
                                    </Link>
                                </div>
                            </div>
...
export default AboutMarketingAgency;
