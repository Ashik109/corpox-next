function SectionRnBlogArea() {
  return (
    <>
      ...
      <div className="row mt_dec--30 mt_sm--0">
      ...
      <div className="col-lg-4 col-md-6 col-12 mt--30" data-aos="slide-up" data-aos-duration="700" data-aos-delay="200">
      <div className="tmp-card box-card-style-default tmponhover">
      <div className="inner">
      <div className="thumbnail invers-anime">
      <a className="image" href="/blog-details">
      ...
      <div className="col-lg-4 col-md-6 col-12 mt--30" data-aos="slide-up" data-aos-duration="700" data-aos-delay="100">
      <div className="tmp-card box-card-style-default tmponhover">
      <div className="inner">
      <div className="content">
      <ul className="inversweb-meta-list">
      ...
      <div className="col-lg-4 col-md-6 col-12 mt--30" data-aos="slide-up" data-aos-duration="700">
      <div className="tmp-card box-card-style-default tmponhover">
      <div className="inner">
      <div className="thumbnail invers-anime">
      <a className="image" href="/blog-details">
...
export default SectionRnBlogArea
