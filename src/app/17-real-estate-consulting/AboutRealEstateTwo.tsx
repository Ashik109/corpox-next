                    ...
                    <div className="col-lg-7 pl--60 pl_md--10 pl_sm--10 mt_md--30 mt_sm--30">
                        <div className="about-wrapper-8">
                            ...
                            <p className="discription">
                                Over <RealEstateOdometer value={39000} /> people work for us in more than 70 countries all over the This breadth of global coverage, combined with specialist
                                services
                            </p>
...
export default AboutRealEstateTwo;
