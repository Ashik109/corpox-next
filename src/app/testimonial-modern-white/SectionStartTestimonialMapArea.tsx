...
const lookbooks = [
  {
    ...
    text: "Their team is always available to answer my questions. I trust them completely with my business insurance.",
  },
  {
    image: "avatar9.webp",
    name: "Katherine",
...
function SectionStartTestimonialMapArea() {
  return (
    <div className="container-fluid">
      ...
      <button className="tmp-lookbook-close-btn" type="button"><i className="fas fa-times"></i></button>
      ...
      <span><span className="tmp-fw-medium tmp-text-heading">{item.name}</span> - UI/UX Designer</span>
      <Rating />
      </div>
      </div>
      </div>
...
export default SectionStartTestimonialMapArea
