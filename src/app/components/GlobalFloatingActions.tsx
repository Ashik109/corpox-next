...
const BUY_URL =
  "https://themeforest.net/item/corpox-business-consulting-bootstrap-5-html-template/59767866";
...
export default function GlobalFloatingActions() {
  ...
  useEffect(() => {
    ...
    const updateFloatingActions = () => {
      ...
      if (isShownRef.current !== isShown) {
        ...
        buyNowRef.current?.classList.toggle("show", isShown);
        buyNowRef.current?.classList.toggle("hide", !isShown);
  ...
  return (
    <>
      <div id="buy-now" className="show-on-scroll hide" ref={buyNowRef}>
        <a
          className="btn-buy"
          href={BUY_URL}
          target="_blank"
        ...
        >
          Buy on{" "}
          <img src="/assets/images/demo/envato.png" className="" alt="" />
        </a>
      </div>
