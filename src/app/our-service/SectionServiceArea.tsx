function SectionServiceArea() {
  return (
    <>
      ...
      <div className="content">
      <h4 className="title w-600">
      <a href="/service-details">Application</a>
      </h4>
      ...
      <div className="content">
      <h4 className="title w-600">
      <a href="/service-details">Support</a>
      </h4>
      ...
      <div className="content">
      <h4 className="title w-600">
      <a href="/service-details">Office</a>
      </h4>
      ...
      <div className="content">
      <h4 className="title w-600">
      <a href="/service-details">Web Award</a>
      </h4>
      ...
      <div className="content">
      <h4 className="title w-600">
      <a href="/service-details">Call Center</a>
      </h4>
      ...
      <div className="content">
      <h4 className="title w-600">
      <a href="/service-details">Managemenet</a>
      </h4>
