                            ...
                            <div className="tmp-footer-widget">
                                ...
                                <div className="inner">
                                    <h6 className="subtitle">
                                        <AgencyThirteenOdometer value={2000} /> Our clients are subscribe Around the World
                                    </h6>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12 col-12">
                            <div className="copyright-right text-center text-md-end">
                                <p className="copyright-text">&copy; All Rights Reserved InversWeb</p>
                            </div>
                        </div>
                    </div>
                </div>
...
export default FooterAgencyThirteen;
