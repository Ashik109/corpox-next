function AppointmentAgencyThirteen() {
    return (
        <div className="inv-appoinment-area-start tmp-section-gapTop">
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-7">
                        <form className="contact-form-1 appoinment-form-wrapper tmponhover tmp-dynamic-form" action="#">
                            ...
                            <div className="form-group">
                                <button name="submit" type="submit" className="btn-default btn-large tmp-btn" style={{ width: "100%" }}>
...
export default AppointmentAgencyThirteen;
