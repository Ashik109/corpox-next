...
function SectionInnerPage() {
  return (
    <>
      <div className="inner-page-area tmp-section-gap bg_inner-page-splash splash">
      ...
      <span className="subtitle-text">Inner Pages</span>
      </span>
      <div className="line-separator line-right"></div>
      </div>
      <h2 className="title w-700 tmp-title-split">All Other <span className="theme-gradient">Inner Pages.</span></h2>
      </div>
      <p className="discription">
                                      Discover <span className="odometer" data-count="100">000</span>+ stunning inner pages built for every business need.
      ...
      <div className="tmp-view-btn">Demo <svg className="tmp-icon-svg" xmlns="http://www.w3.org/2000/svg" width={9} height={9} viewBox="0 0 8 8" fill="currentColor">
...
export default SectionInnerPage
