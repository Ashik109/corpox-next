...
function SectionServiceStyle1Area2() {
  return (
    <>
      ...
      <h2 className="title w-700 tmp-title-split">Our Popular <span className="theme-gradient"> Services. </span></h2>
      </div>
      </div>
      </div>
...
export default SectionServiceStyle1Area2
