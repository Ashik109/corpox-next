function SectionService8Area2() {
  return (
    <>
      <div className="tmp-service-area tmp-section-gap"></div>
      ...
      <h2 className="title w-700 tmp-title-split">Services <span className="theme-gradient">Transperent.</span></h2>
      </div>
      </div>
      </div>
    </>
...
export default SectionService8Area2
