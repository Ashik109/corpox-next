...
function SectionIClassFeatherMoreHorizontalI2() {
  return (
    <>
      <img src="/assets/images/services/icons/06.png" alt="service" />

      <div className="content">
      <h4 className="title w-600"><Link href="/service/management-leadership">& More</Link></h4>
...
export default SectionIClassFeatherMoreHorizontalI2
