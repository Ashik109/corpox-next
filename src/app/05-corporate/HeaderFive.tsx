    ...
    return (
        <>
            ...
            <div className="header-transparent-with-topbar">
                {/* Start Header Area  */}
                <header className={`tmp-header header-default header-not-transparent with-blur header-sticky ${isSticky ? 'sticky' : ''} ${className}`}>
                                                        ...
                                                        <div className="tab-pane multipage_content active">
                                                            ...
                                                            <ul className="mega-menu-item">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/white-05-corporate">Corporate</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="11-hr-website"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/white-11-hr-website">HR Website</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="/06-startup"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/22-solar">Solar Renewable Energy</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="/white-22-solar"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/22-solar">Event &amp; Conferance</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="/white-23-event"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/25-architecture">Architecture</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                        ...
                                                        <div className="tab-pane onepage_content">
                                                            ...
                                                            <ul className="mega-menu-item">
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-two">Business Consulting</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-four">Services Agency</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-five-white">Corporate</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="/onepage-eleven"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-eleven-white">HR Website</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="/onepage-six"
                                                                    ...
                                                                    <Link href="/onepage-six">Startup Business</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-seven">Creative Agency</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-eight-white">Business</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                        href="/onepage-nine"
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-ten">Marketing Agency</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-thirteen-white">Agency 2</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <Link href="/onepage-fifteen">Business Coach</Link>
                                                                </li>
                                                                <li>
                                                                    <Link
                                        ...
                                        <div className="row row--0">
                                            <div className="col-xl-2 col-lg-3 single-mega-item">
                                                <ul className="mega-menu-item">
                                                    ...
                                                    <li>
                                                        <Link href="/our-service-three">Our Service Three</Link>
                                                    </li>
                                                    <li>
                                            ...
                                            <div className="col-xl-2 col-lg-3 single-mega-item">
                                                <ul className="mega-menu-item">
                                                    ...
                                                    <li>
                                                        <Link href="/team/monsur-mia">Team Details</Link>
                                                    </li>
                                                    <li>
                                            ...
                                            <div className="col-xl-2 col-lg-3 single-mega-item">
                                                <ul className="mega-menu-item">
                                                    ...
                                                    <li>
                                                        <Link href="/blog/leadership-confidence">Blog Details</Link>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div className="col-xl-2 col-lg-3 single-mega-item">
                                                <ul className="mega-menu-item">
                                                    ...
                                                    <li>
                                                        <Link href="/testimonial-three">Testimonial Three</Link>
                                                    </li>
                                                    <li>
                                                        <Link href="/testimonial-modern">Testimonial Modern</Link>
                                                    </li>
                                                    <li>
                                            ...
                                            <div className="col-xl-4 d-lg-none d-xl-block">
                                                <Link href="/contact" className="feature-image-add-header">
                                                    <img
                                                        loading="lazy"
