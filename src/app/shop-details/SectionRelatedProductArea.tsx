function SectionRelatedProductArea() {
  return (
    <>
      ...
      <a href="/wishlist" className="wishlist"><img src="/assets/images/shop/heart.svg" alt="" /></a>
      ...
      <a href="/cart" className="tmp-btn cart-btn btn-primary">Add To Cart <i className="feather-shopping-cart"></i></a>
      </div>
      </div>
      </div>
      </div>
      ...
      <div className="content">
      <h6 className="title"><a href="/shop-details">Picker Panel Boards stop&nbsp;</a></h6>
      <p className="price">$99 <span>$390</span></p>
      <div className="star-rating">
      <ul>
      <li><i className="feather-star"></i></li>
      ...
      <div className="content">
      <h6 className="title"><a href="/shop-details">Boost Panel Boards stop&nbsp;</a></h6>
      <p className="price">$99 <span>$390</span></p>
      <div className="star-rating">
      <ul>
      <li><i className="feather-star"></i></li>
