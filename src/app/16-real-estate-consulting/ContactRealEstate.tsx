function ContactRealEstate() {
    return (
        <div className="contact-area-agency tmp-section-gapTop finance">
                ...
                <div className="row g-5">
                    ...
                    <div className="col-lg-7">
                        <form className="contact-form-1 tmp-dynamic-form" action="#">
                            {[
                                ["real-contact-name", "contact-name", "text", "Your Name"],
                                ["real-contact-phone", "contact-phone", "text", "Phone Number"],
                                ["real-contact-email", "contact-email", "email", "Your Email"],
                                ["real-subject", "subject", "text", "Your Subject"],
                            ...
                            <div className="form-group tmponhover">
                                <textarea name="contact-message" id="real-contact-message" placeholder="Your Message" />
                            </div>
                            <div className="form-group tmponhover">
                                <button name="submit" type="submit" id="real-submit" className="btn-default btn-large tmp-btn w-100">
