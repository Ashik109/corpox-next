...
const sideBlogs = [
    ["blog-02.jpg", "How to Analyze Your Best Pages for SEO Performance"],
    ["blog-03.jpg", "How to Analyze Your Best Pages for SEO Performance"],
    ["blog-01.jpg", "How to Analyze Your Best Pages for SEO Performance"],
] as const;

function BlogRealEstate() {
    return (
