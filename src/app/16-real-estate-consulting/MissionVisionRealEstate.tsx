...
function Media({ image }: { image: string }) {
    return (
        <div className="col-lg-6 mt_md--30 mt_sm--40">
                ...
                <div className="inner">
                    ...
                    <ul className="feature-list">
                        {features.map((feature, index) => (
                            <li data-aos="slide-up" key={`${section.label}-${index}`}>
                                <div className="icon">
...
function MissionVisionRealEstate() {
    return (
        <>
...
export default MissionVisionRealEstate;
