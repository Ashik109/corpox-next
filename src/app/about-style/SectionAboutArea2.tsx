function SectionAboutArea2() {
  return (
    <>
      ...
      <a className="tmp-btn btn-primary round btn-large" href="/about">More About Us</a>
      <a className="tmp-btn btn-border round btn-large" href="/contact">Contact With Us</a>
      </div>
      </div>
      </div>
      </div>
