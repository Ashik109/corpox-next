...
function TestimonialFinancial() {
    return (
        <section className="tmp-section-gapTop mb--80 bg-card position-relative overflow-hidden">
                ...
                <div className="tmp-testimonial-map-wrapper">
                    ...
                    <div className="tmp-testimonial-bottom-area">
                        <h4 className="tmp-counter tmp-count tmp-w-fit mx-auto mb--0">
                            <FinancialOdometer value={216000} />
...
export default TestimonialFinancial;
