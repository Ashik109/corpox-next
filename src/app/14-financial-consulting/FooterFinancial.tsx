                    ...
                    <div className="col-12 col-xxl-8 pr--50">
                        ...
                        <div className="tmp-copyright-area-3">
                            <p className="m-0 tmp-copyright">
                                Copyright <Link className="tmp-hover-underline" href="/">Corpox</Link>. All Rights Reserved
                            </p>
                                ...
                                <div className="widget-inner">
                                    ...
                                    <form className="tmp-newsletter-form" autoComplete="off">
                                        ...
                                        <div className="tmp-input-field">
                                            <input id="tmp-checkbox-14" name="tmp-checkbox-14" type="checkbox" value="yes" />
                                            <label className="tmp-checkbox" htmlFor="tmp-checkbox-14">
