...
function SectionCheckout() {
  return (
    <>
      ...
      <span>Returning customers? <Link href="#">Click here to login</Link></span>
      </div>
      ...
      <button className="accordion-toggle" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Click here to enter your code</button>
      </div>
      </div>
      ...
      <button className="add-btn tmp-btn btn-primary border-0" type="submit">Apply
                                                          Coupon</button>
      </div>
      </div>
      </div>
      ...
      <option value="BD" selected>Bangladesh
                                                          </option>
      ...
      <textarea name="notes" className="form-control-mod" id="notes"></textarea>
      </div>
      </div>
      </div>
      <div className="row">
      <div className="col-md-12 col-sm-12 col-xs-12">
      <div className="form-group">
      <button type="submit" className="tmp-btn btn-primary border-0">Update Cart</button>
      </div>
      </div>
      </div>
      </div>
      ...
      <div className="text">
      <h6>Solar Energy Audits: Optimizing Your </h6>
      </div>
      </div>
      <div className="right">
      ...
      <div className="text">
      <h6>Xolar Energy Audits: Optimizing Your </h6>
      </div>
      </div>
      <div className="right">
      <p className="price">$500.00</p>
      ...
      <p>Shipping</p>
      <div className="right">
      <p className="price"><span>Flat rate:</span> $500.00</p>
      </div>
      </div>
      <div className="shipping-area cart-total border-0">
      <p className="cb">Total Price:</p>
      <div className="right">
      <p className="price cg">$550.00</p>
      </div>
      </div>
      ...
      <p className="desc">Make your payment directly into our bank account. Please use your Order ID as the payment reference. Your order will not be shipped until the funds have cleared in our account.</p>
      <label className="option">
