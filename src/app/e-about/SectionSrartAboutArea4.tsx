...
function SectionSrartAboutArea4() {
  return (
    <>
      ...
      <Link className="tmp-btn round btn-large btn-border" href="/contact">Lets Contact Us</Link>
      </div>
      </div>
      </div>
      </div>
...
export default SectionSrartAboutArea4
