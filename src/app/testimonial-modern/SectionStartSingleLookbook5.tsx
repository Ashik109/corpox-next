function SectionStartSingleLookbook5() {
  return (
    <>
      <div className="tmp-lookbook-portion portion-xl" data-tmp-position-vertical="30" data-tmp-position-horigental="73">
      ...
      <span>
      <span className="tmp-fw-medium tmp-text-heading">Sarah Tery.</span> - UI/UX
                                                      Designer</span>
...
export default SectionStartSingleLookbook5
