function SectionAccordion1Area2() {
  return (
    <>
      <div className="tmp-accordion-area tmp-section-gapBottom">
      ...
      <img className="w-100 radius" src="/assets/images/about/about-4.png" alt="About Images" />
      </div>
      </div>
      <div className="col-lg-6">
      ...
      <div className="accordion-body card-body">
                                                          ...
                                                          us with sending mail to prsit10@gmail.com.
                                                      </div>
      </div>
      </div>
      <div className="accordion-item card tmponhover">
...
export default SectionAccordion1Area2
