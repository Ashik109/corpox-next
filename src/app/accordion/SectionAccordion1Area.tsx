function SectionAccordion1Area() {
  return (
    <>
      ...
      <img className="w-100 radius" loading="lazy" src="/assets/images/about/about-4.png" alt="About Images" />
      </div>
      </div>
      <div className="col-lg-6">
...
export default SectionAccordion1Area
