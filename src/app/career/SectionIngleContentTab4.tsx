function SectionIngleContentTab4() {
  return (
    <>
      ...
      <h4 className="title"><a href="/career-details">Manufacturing Operations Manager</a></h4>
      ...
      <a href="/career-details" className="text-btn">View Careers Details</a>
      </div>
      </div>
      </div>
      <div className="col-lg-6 col-md-6 col-sm-12">
      ...
      <div className="content">
      <h4 className="title"><a href="/career-details">Production Supervisor</a></h4>
      ...
      <div className="content">
      <h4 className="title"><a href="/career-details">Supply Chain Coordinator</a></h4>
      ...
      <div className="content">
      <h4 className="title"><a href="/career-details">Quality Control Specialist</a></h4>
...
export default SectionIngleContentTab4
