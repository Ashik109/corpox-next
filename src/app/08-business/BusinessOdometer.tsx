...
type BusinessOdometerProps = {
    value: number;
    className?: string;
};

function BusinessOdometer({ value, className = "odometer" }: BusinessOdometerProps) {
    ...
    return (
        <span ref={ref} className={className} data-count={value}>
            0
        </span>
    );
}

export default BusinessOdometer;
