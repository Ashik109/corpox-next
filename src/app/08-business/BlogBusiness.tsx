...
const listBlogs = [
    ...
    { image: "/assets/images/blog/07.jpg", title: "How to Analyze Your Best Pages for SEO Performance" },
    { image: "/assets/images/blog/08.jpg", title: "How to Analyze Your Best Pages for SEO Performance" },
];
                            ...
                            <div className="inner">
                                <div className="thumbnail invers-anime">
                                    <Link className="image" href="/blog/best-corporate-tips">
                                        <img className="w-100" src="/assets/images/blog/01.webp" alt="Blog Image" />
                                    </Link>
                                </div>
