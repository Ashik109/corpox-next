                        ...
                        <div className="col-lg-12">
                            <div className="footer-message-and-form">
                                <p className="colophon">
                                    Corpox is powered by <Link href="https://themeforest.net/user/inversweb">InversWeb</Link>.
                                </p>
                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-6 col-sm-6 col-12">
                            <div className="tmp-footer-widget">
                                <div className="logo">
                                    <Link href="/">
                                        <img className="logo-light" src="/assets/images/logo/construction-logo.svg" alt="Corpox Construction" />
                                        <img className="logo-dark" src="/assets/images/logo/construction-logo-dark.svg" alt="Corpox Construction" />
                                    </Link>
                                </div>
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-6 col-md-4 col-sm-12 col-12">
                            <div className="copyright-right text-center text-lg-end">
                                <p className="copyright-text">All Right &copy; Corpox</p>
                            </div>
                        </div>
                    </div>
                </div>
