function SectionStartSingleProgressBar3() {
  return (
    <>
      <div className="col-lg-3 col-md-6 col-sm-6 mt--30 col-12">
      <div className="radial-progress-single">
      <div className="radial-progress" data-percent="70" data-bar-color="#3228e0" data-track-color="#16172e">
...
export default SectionStartSingleProgressBar3
