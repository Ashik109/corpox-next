function SectionStartSingleProgressBar8() {
  return (
    <>
      <div className="col-lg-3 col-md-6 col-12 col-sm-6 mt--30">
      <div className="radial-progress-single">
      <div className="radial-progress" data-percent="95" data-bar-color="#36C6F0" data-track-color="#16172e">
...
export default SectionStartSingleProgressBar8
