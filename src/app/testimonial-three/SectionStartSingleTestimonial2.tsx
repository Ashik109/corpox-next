...
function SectionStartSingleTestimonial2() {
  return (
    <>
      ...
      <div className="thumbnail"><img className="w-100" src="/assets/images/testimonial/testimonial-dark-02.jpg" alt="Corporate Template" /></div>
      </div>
      ...
      <div className="coll-lg-12"></div>
    </>
  )
}

export default SectionStartSingleTestimonial2
