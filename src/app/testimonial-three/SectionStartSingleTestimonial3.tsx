...
function SectionStartSingleTestimonial3() {
  return (
    <>
      ...
      <div className="thumbnail"><img className="w-100" src="/assets/images/testimonial/testimonial-dark-03.jpg" alt="Corporate Template" /></div>
      </div>
...
export default SectionStartSingleTestimonial3
