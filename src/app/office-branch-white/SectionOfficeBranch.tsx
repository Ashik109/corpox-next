function SectionOfficeBranch() {
  return (
    <>
      <section className="tmp-office-branch-area tmp-section-gapBottom ">
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/10.webp" width={293} alt="" />
      </div>
      ...
      <a href="/contact-white" className="tmp-btn btn-primary btn-two">Get Direction <i className="feather-arrow-right"></i></a>
      </div>
      </div>
      </div>
      <div className="col-xl-6" data-aos="slide-up" data-aos-duration="800" data-aos-delay="300">
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/10.webp" width={293} alt="" />
      </div>
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/11.webp" width={293} alt="" />
      </div>
      <div className="content">
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/12.webp" width={293} alt="" />
      </div>
      <div className="content">
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/13.webp" width={293} alt="" />
      </div>
      <div className="content">
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/14.webp" width={293} alt="" />
      </div>
      <div className="content">
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/15.webp" width={293} alt="" />
      </div>
      <div className="content">
      ...
      <div className="branch-wrapper tmponhover">
      <div className="image-area">
      <img src="/assets/images/story/16.webp" width={293} alt="" />
      </div>
      <div className="content">
...
export default SectionOfficeBranch
