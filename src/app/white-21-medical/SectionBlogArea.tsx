...
function SectionBlogArea() {
  return (
    <>
      ...
      <h4 className="title">
      <Link href="/blog-details-white">How to Improve Patient Care with Modern Health care Medical service</Link>
      </h4>
      ...
      <h4 className="title">
      <Link href="/blog-details-white">Hospital Management Systems for Better Patient Care</Link>
      </h4>
      <p className="descriptiion">
      ...
      <h4 className="title">
      <Link href="/blog-details-white">Medical Technology Advancing Modern Patient Treatment</Link>
      </h4>
      <p className="descriptiion">
...
export default SectionBlogArea
