...
function SectionAboutArea() {
  return (
    <>
      ...
      <p><span className="odometer" data-count="599">00</span> Review form our <br /> Best Patients</p>
      ...
      <Link className="tmp-btn round text-center" href="/about-white">Learn More About Our Clinic</Link>
      </div>
      </div>
      </div>
      </div>
