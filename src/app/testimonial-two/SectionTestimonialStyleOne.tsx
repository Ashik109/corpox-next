...
function SectionTestimonialStyleOne() {
  ...
  return (
    <>
      ...
      <Slider {...settings} className="tmp-slick-dot tmp-slick-arrow testimonial-activation-2 testimonial-two-slider slick-gutter-15 mt--30 mb--60">
      ...
      <style jsx global>{`
        .testimonial-two-slider.slick-gutter-15 {
          margin-left: -15px !important;
          margin-right: -15px !important;
        }

        .testimonial-two-slider.slick-gutter-15 .slick-slide {
