                ...
                <div className="position-sticky-top-120">
                  <div className="team-content-area">
                    ...
                    <ul className="social-icon social-default justify-content-start">
                      <li><Link href="https://www.facebook.com/"><i className="feather-facebook" /></Link></li>
                      <li><Link href="https://www.twitter.com"><i className="feather-twitter" /></Link></li>
                      <li><Link href="https://www.instagram.com/"><i className="feather-instagram" /></Link></li>
                      <li><Link href="https://www.linkedin.com/"><i className="feather-linkedin" /></Link></li>
                    </ul>
                  </div>
